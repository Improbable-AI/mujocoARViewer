...
class MuJoCoARServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamHandUpdates = channel.stream_stream(
                '/mujoco_ar.MuJoCoARService/StreamHandUpdates',
                request_serializer=mujoco__ar__pb2.HandUpdate.SerializeToString,
                response_deserializer=mujoco__ar__pb2.HandUpdateResponse.FromString,
                )
...
class MuJoCoARServiceServicer(object):
    ...
    def StreamHandUpdates(self, request_iterator, context):
        """Bilateral stream for hand tracking data from VR device to simulation
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MuJoCoARServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamHandUpdates': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=mujoco__ar__pb2.HandUpdateResponse.SerializeToString,
            ),
    }
...
class MuJoCoARService(object):
    ...
    def StreamHandUpdates(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/mujoco_ar.MuJoCoARService/StreamHandUpdates',
            mujoco__ar__pb2.HandUpdate.SerializeToString,
            mujoco__ar__pb2.HandUpdateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
